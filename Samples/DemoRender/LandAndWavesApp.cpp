...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L".\\Shaders\\color.sl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L".\\Shaders\\color.sl", nullptr, "PS", "ps_5_0");
